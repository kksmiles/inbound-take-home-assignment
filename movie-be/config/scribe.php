...
return [
    ...
    'auth' => [
        ...
        // We're keeping this false and marking specific endpoints with @authenticated.
        'default' => false,

        // Where is the auth value meant to be sent in a request?
        // We're using a Bearer token in the Authorization header (eg "Authorization: Bearer {token}").
        ...
        // Set SCRIBE_AUTH_BEARER in your .env to a valid personal access token if you want response calls to hit real data.
        ...
        'extra_info' => 'First call the <b>Login</b> endpoint to obtain a token. Then paste it here in the format <code>Bearer your-token-here</code> to use the Try It Out feature.',
    ],
